...
2026-09-13 원본 페이지의 CC0 표시를 확인했다. 모든 음원은 앱 번들에 포함하며 외부 서비스로 이용자 정보를 보내지 않는다.

| 파일       | 원작 / 저작자                  | 원본 페이지                                          |
| ---------- | ------------------------------ | ---------------------------------------------------- |
| fire.mp3   | Fireplace Sound loop / PagDev  | https://opengameart.org/content/fireplace-sound-loop |
| rain.mp3   | Rain (loopable), 1.mp3 / Ylmir | https://opengameart.org/content/rain-loopable        |
