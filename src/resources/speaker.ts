...
export const SPEAKER_TRACKS = [
  { id: 'fire', name: '모닥불', source: require('@/assets/audio/speaker/fire.mp3') },
  {
    id: 'rain',
    name: '창밖의 빗소리',
    source: require('@/assets/audio/speaker/rain.mp3'),
  },
  {
    id: 'forest',
    name: '숲의 분위기',
    source: require('@/assets/audio/speaker/forest.mp3'),
  },
  {
    id: 'piano',
    name: '조용한 피아노',
    source: require('@/assets/audio/speaker/piano.mp3'),
  },
] as const;
