...
export type SemanticColors = {
  ...
  success: string;
  /** Calendar markers and informational highlights. */
  info: string;
...
export const Radius = {
  ...
  lg: 16,
  /**
   * 시트·모달·큰 카드 (#1015). lg(16) 다음이 곧장 pill(999)이라 그 사이가
   * 비어 있었고, 화면 13곳이 각자 `borderRadius: 20`을 적어 썼다 — 토큰이
   * 없어서 생긴 드리프트라 값을 늘려 흡수한다.
   */
  xl: 20,
  pill: 999,
} as const;
