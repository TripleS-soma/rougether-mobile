...
export const DarkThemes: Record<ThemeId, SemanticColors> = {
  ...
  // primaryText로 그대로 쓰고(대비 통과), primaryActive는 라이트 primary값.
  latte: {
    appShell: '#16120D',
    screen: '#201A13',
    surface: '#2E261F',
...
export const THEME_OPTIONS: ThemeOption[] = [
  ...
  { id: 'latte', name: '라떼', swatch: '#B98E62' },
  { id: 'citrus', name: '시트러스 그로브', swatch: '#7EA83E' },
  { id: 'pastel', name: '파스텔 캔디', swatch: '#F79B8D' },
  { id: 'indigo', name: '인디고 타이드', swatch: '#0E86B8' },
];
