 ...
 */
export function houseCapacityOptions(current?: number): number[] {
  const base = [...HOUSE_CAPACITY_OPTIONS];
  return current != null && current > HOUSE_CAPACITY_MAX ? [...base, current] : base;
}
