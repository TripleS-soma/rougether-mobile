...
describe('Room', () => {
  it.each([
    ...
    async ({ fill, frames }) => {
      ...
      const staticFrame = StyleSheet.flatten(getByTestId('room-character').props.style);
      ...
      expect(StyleSheet.flatten(getByTestId('room-character').props.style)).toEqual(staticFrame);
